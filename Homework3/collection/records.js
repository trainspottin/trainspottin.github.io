...
app.collections.Records = Backbone.Collection.extend({
  initialize: function() { 
   this.add( {id:1, createDate:"Create Date", title:"Title", type:"Type", tags:"Tags", from:"YourAccount", to:"MyAccount", total:1000 , detail:"Detail", attachments: "Attachments", issueDate: "Issue Date", paidDate: "Paid Date"});
